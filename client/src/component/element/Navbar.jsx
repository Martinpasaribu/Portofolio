...
export const Navbar = () => {
  return (
    <div className=' bg-white font-Montserrat text-[13px] flex items-center justify-center'>
        <div className='flex justify-between items-center w-[63rem] h-[4rem]'>
          <div  className='w-[8rem] h-[3rem] m-2 mx-3'>
            <img src={Logo} alt="" className='w-full' />
          </div>
          <ul className='flex items-center gap-[2rem] mx-5 font-bold'>
