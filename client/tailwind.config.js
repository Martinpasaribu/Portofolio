  ...
  theme: {
    ...
    extend: {
      animation: {
        ...
        bawah: 'fade-up 2s ease-in ',
        bawah2: 'fade-up .7s ease ',
        kerja: 'fade-up 1s ease-in-out ',
        contac: 'fade-up .7s ease-in-out ',
        miringatas: 'miringatas .5s ease-in-out ',
        miringbawah: 'miringbawah .5s ease-in-out ',
        // muncul: 'fade-up hidden 2s 3s ease ',
        muncul: 'fade-right  1s  ease-in-out ',
        miringtengah: 'miringtengah  .5s  ease-in-out ',
        fadeup: 'fade 3s ease-in',
        navbar: 'navbar 0.5s ease ',
        navbar2: 'navbar2 0.5s ease ',
        fadeIn: 'fadeIn 2s ease-in-out',
        riple: 'riple  1s linear infinite',
      ...
      boxShadow: {
        ...
        '3xl': ' 0px 8px 40px 8px rgba(0.5, 0, 0, 0.8)',
        'bayang': '0px 0px 8px 2px rgba(0, 0, 0, 0.3)',
        'bayang2': '0px 10px 8px 2px rgba(0, 0, 0, 0.3)',
      },
      backgroundSize: {
        'auto': 'auto',
        'cover': 'cover',
      ...
      backgroundImage:{
        ...
        'coba': 'url(/src/assets/bg/bg2.jpg)',
      },
      keyframes: {
        scrolling: {
        ...
        muncul: {
          '0%': { transform: 'translateY(20%)' }, /* Mulai dari di luar layar sebelah kanan */
          '100%': { transform: 'translateY(0%)' }, /* Akhir di luar layar sebelah kiri */
        },
        navbar: {
        ...
        miringbawah: {
          '0%': { transform: 'translateX(-45%) translateY(-45%)', opacity : 0 }, /* Mulai dari di luar layar sebelah kanan */
          '100%': { transform: 'trtranslateX(0%) ',opacity : 1 }, /* Akhir di luar layar sebelah kiri */
        },
        miringtengah: {
          '0%': { transform: ' translateX(-45%) ',opacity : 0  }, /* Mulai dari di luar layar sebelah kanan */
          '100%': { transform:  'trtranslateX(0%)',opacity : 1 }, /* Akhir di luar layar sebelah kiri */
        },
        miringatas: {
          '0%': { transform: 'translateY(45%) translateX(-45%) ' , opacity : 0 }, /* Mulai dari di luar layar sebelah kanan */
          '100%': { transform:  'trtranslateX(0%) trtranslateY(0%) ',opacity : 1 }, /* Akhir di luar layar sebelah kiri */
        },
        fadeIn : {
        ...
        riple : {
          '0%': {width:'0px',height:'0px', opacity: 0.5 }, /* Mulai dari di luar layar sebelah kanan */
          '100%': { width:'500px',height:'500px', opacity: 0 }, /* Akhir di luar layar sebelah kiri */
        },
        swing: {
          '20%': {
